...
export { extractVerificationUrl, schemeForTarget, buildVerificationUrl, trimToFirstLinePattern, extractCertText, findStrandedText, extractDomain, buildMetaUrl, fetchVerificationMeta, verifyHash, checkAuthorization, walkAuthorizationChain };

// CommonJS exports (for Node.js testing)
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { extractVerificationUrl, schemeForTarget, buildVerificationUrl, trimToFirstLinePattern, extractCertText, findStrandedText, extractDomain, buildMetaUrl, fetchVerificationMeta, verifyHash, checkAuthorization, walkAuthorizationChain };
}
